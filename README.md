...
## Я создаю консоль, чтобы работать с БД намного быстрее через консоль, при этом будет поддержка MySQL, возможно, я буду поддерживать эту программу и добавлю postgreSql и т.д. Но пока я работаю над простой консолью с подключением к БД.
>[!TIP]
> файл, в котором хранятся данные для БД, находится по адресу src/main/resources/config/database.properties
